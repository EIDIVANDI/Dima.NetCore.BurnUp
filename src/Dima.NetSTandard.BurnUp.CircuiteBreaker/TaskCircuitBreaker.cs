...
namespace Dima.NetSTandard.BurnUp.CircuiteBreaker
{
    ...
    public class TaskCircuitBreaker : ITaskBreaker
    {
        private readonly IRunningTastState _closedState;
        private readonly IRunningTastState _halfOpenedState;
        private readonly IRunningTastState _openedState;

        private IRunningTastState _currentState;
